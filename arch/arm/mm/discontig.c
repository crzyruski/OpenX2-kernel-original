 ...
 */
//#if defined(CONFIG_PXA3xx) /* donot reuse bootmem_node_data as it live in init section, by frank */
#if 1 /* donot reuse bootmem_node_data as it live in init section, by frank */
