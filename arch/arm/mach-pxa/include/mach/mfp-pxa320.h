...
/* AC97 */
#define GPIO40_AC97_nACRESET	MFP_CFG_LPM(GPIO40, AF1, PULL_HIGH)
#define GPIO34_AC97_SYSCLK	MFP_CFG_LPM(GPIO34, AF1, PULL_LOW)
#define GPIO39_AC97_BITCLK	MFP_CFG_LPM(GPIO39, AF1, PULL_LOW)
#define GPIO35_AC97_SDATA_IN_0	MFP_CFG_LPM(GPIO35, AF1, PULL_LOW)
#define GPIO37_AC97_SDATA_OUT	MFP_CFG_LPM(GPIO37, AF1, PULL_LOW)
#define GPIO38_AC97_SYNC	MFP_CFG_LPM(GPIO38, AF1, PULL_LOW)
...
#define GPIO102_CI_HI_PWDN	MFP_CFG_DRV(GPIO102, AF0, DS04X)
#define GPIO103_CI_LO_PWDN	MFP_CFG_DRV(GPIO103, AF0, DS04X)
...
#define GPIO104_USB_P2_7	MFP_CFG_X(GPIO104, AF2, DS01X, FLOAT)
