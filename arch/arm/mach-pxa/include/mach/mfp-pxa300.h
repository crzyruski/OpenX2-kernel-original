...
#else /* enable pull_low by frank */
#define GPIO3_KP_DKIN_6		MFP_CFG_LPM(GPIO3,   AF2, PULL_LOW) | 0x8000
#define GPIO4_KP_DKIN_7		MFP_CFG_LPM(GPIO4,   AF2, PULL_LOW) | 0x8000
#define GPIO16_KP_DKIN_6	MFP_CFG_LPM(GPIO16,  AF6, PULL_LOW) | 0x8000
#define GPIO83_KP_DKIN_2	MFP_CFG_LPM(GPIO83,  AF5, PULL_LOW) | 0x8000
#define GPIO84_KP_DKIN_1	MFP_CFG_LPM(GPIO84,  AF5, PULL_LOW) | 0x8000
#define GPIO85_KP_DKIN_0	MFP_CFG_LPM(GPIO85,  AF3, PULL_LOW) | 0x8000
#define GPIO86_KP_DKIN_1	MFP_CFG_LPM(GPIO86,  AF3, PULL_LOW) | 0x8000
#define GPIO87_KP_DKIN_2	MFP_CFG_LPM(GPIO87,  AF3, PULL_LOW) | 0x8000
#define GPIO88_KP_DKIN_3	MFP_CFG_LPM(GPIO88,  AF3, PULL_LOW) | 0x8000
#define GPIO89_KP_DKIN_3	MFP_CFG_LPM(GPIO89,  AF3, PULL_LOW) | 0x8000
#define GPIO107_KP_DKIN_0	MFP_CFG_LPM(GPIO107, AF2, PULL_LOW) | 0x8000
#define GPIO108_KP_DKIN_1	MFP_CFG_LPM(GPIO108, AF2, PULL_LOW) | 0x8000
#define GPIO109_KP_DKIN_2	MFP_CFG_LPM(GPIO109, AF2, PULL_LOW) | 0x8000
#define GPIO110_KP_DKIN_3	MFP_CFG_LPM(GPIO110, AF2, PULL_LOW) | 0x8000
#define GPIO111_KP_DKIN_4	MFP_CFG_LPM(GPIO111, AF2, PULL_LOW) | 0x8000
#define GPIO112_KP_DKIN_5	MFP_CFG_LPM(GPIO112, AF2, PULL_LOW) | 0x8000
#define GPIO113_KP_DKIN_6	MFP_CFG_LPM(GPIO113, AF2, PULL_LOW) | 0x8000
#define GPIO114_KP_DKIN_7	MFP_CFG_LPM(GPIO114, AF2, PULL_LOW) | 0x8000
#define GPIO115_KP_DKIN_0	MFP_CFG_LPM(GPIO115, AF2, PULL_LOW) | 0x8000
#define GPIO116_KP_DKIN_1	MFP_CFG_LPM(GPIO116, AF2, PULL_LOW) | 0x8000
#define GPIO117_KP_DKIN_2	MFP_CFG_LPM(GPIO117, AF2, PULL_LOW) | 0x8000
#define GPIO118_KP_DKIN_3	MFP_CFG_LPM(GPIO118, AF2, PULL_LOW) | 0x8000
#define GPIO119_KP_DKIN_4	MFP_CFG_LPM(GPIO119, AF2, PULL_LOW) | 0x8000
#define GPIO120_KP_DKIN_5	MFP_CFG_LPM(GPIO120, AF2, PULL_LOW) | 0x8000
#define GPIO121_KP_DKIN_6	MFP_CFG_LPM(GPIO121, AF2, PULL_LOW) | 0x8000
#define GPIO122_KP_DKIN_5	MFP_CFG_LPM(GPIO122, AF2, PULL_LOW) | 0x8000
#define GPIO123_KP_DKIN_4	MFP_CFG_LPM(GPIO123, AF2, PULL_LOW) | 0x8000
#define GPIO124_KP_DKIN_3	MFP_CFG_LPM(GPIO124, AF2, PULL_LOW) | 0x8000
#define GPIO127_KP_DKIN_0	MFP_CFG_LPM(GPIO127, AF5, PULL_LOW) | 0x8000
#define GPIO0_2_KP_DKIN_0	MFP_CFG_LPM(GPIO0_2, AF2, PULL_LOW) | 0x8000
#define GPIO1_2_KP_DKIN_1	MFP_CFG_LPM(GPIO1_2, AF2, PULL_LOW) | 0x8000
#define GPIO2_2_KP_DKIN_6	MFP_CFG_LPM(GPIO2_2, AF2, PULL_LOW) | 0x8000
#define GPIO3_2_KP_DKIN_7	MFP_CFG_LPM(GPIO3_2, AF2, PULL_LOW) | 0x8000
#define GPIO4_2_KP_DKIN_1	MFP_CFG_LPM(GPIO4_2, AF2, PULL_LOW) | 0x8000
#define GPIO5_2_KP_DKIN_0	MFP_CFG_LPM(GPIO5_2, AF2, PULL_LOW) | 0x8000
#endif
...
#else  /* set pull_low by frank */
#define GPIO5_KP_MKIN_0		MFP_CFG_LPM(GPIO5,   AF2, PULL_LOW)
#define GPIO6_KP_MKIN_1		MFP_CFG_LPM(GPIO6,   AF2, PULL_LOW)
#define GPIO9_KP_MKIN_6		MFP_CFG_LPM(GPIO9,   AF3, PULL_LOW)
#define GPIO10_KP_MKIN_7	MFP_CFG_LPM(GPIO10,  AF3, PULL_LOW)
#define GPIO70_KP_MKIN_6	MFP_CFG_LPM(GPIO70,  AF3, PULL_LOW)
#define GPIO71_KP_MKIN_7	MFP_CFG_LPM(GPIO71,  AF3, PULL_LOW)
#define GPIO100_KP_MKIN_6	MFP_CFG_LPM(GPIO100, AF7, PULL_LOW)
#define GPIO101_KP_MKIN_7	MFP_CFG_LPM(GPIO101, AF7, PULL_LOW)
#define GPIO112_KP_MKIN_6	MFP_CFG_LPM(GPIO112, AF4, PULL_LOW)
#define GPIO113_KP_MKIN_7	MFP_CFG_LPM(GPIO113, AF4, PULL_LOW)
#define GPIO115_KP_MKIN_0	MFP_CFG_LPM(GPIO115, AF1, PULL_LOW)
#define GPIO116_KP_MKIN_1	MFP_CFG_LPM(GPIO116, AF1, PULL_LOW)
#define GPIO117_KP_MKIN_2	MFP_CFG_LPM(GPIO117, AF1, PULL_LOW)
#define GPIO118_KP_MKIN_3	MFP_CFG_LPM(GPIO118, AF1, PULL_LOW)
#define GPIO119_KP_MKIN_4	MFP_CFG_LPM(GPIO119, AF1, PULL_LOW)
#define GPIO120_KP_MKIN_5	MFP_CFG_LPM(GPIO120, AF1, PULL_LOW)
#define GPIO125_KP_MKIN_2	MFP_CFG_LPM(GPIO125, AF2, PULL_LOW)
#define GPIO2_2_KP_MKIN_6	MFP_CFG_LPM(GPIO2_2, AF1, PULL_LOW)
#define GPIO3_2_KP_MKIN_7	MFP_CFG_LPM(GPIO3_2, AF1, PULL_LOW)
#endif
...
/* LCD */
//#if defined(CONFIG_FB_LCD_SHARP_LR388) && !defined(CONFIG_BOARD_X2_V4)
#if 0
#define GPIO54_LCD_LDD_0	MFP_CFG_DRV(GPIO54, AF1, DS04X)
#define GPIO55_LCD_LDD_1	MFP_CFG_DRV(GPIO55, AF1, DS04X)
#define GPIO56_LCD_LDD_2	MFP_CFG_DRV(GPIO56, AF1, DS04X)
#define GPIO57_LCD_LDD_3	MFP_CFG_DRV(GPIO57, AF1, DS04X)
#define GPIO58_LCD_LDD_4	MFP_CFG_DRV(GPIO58, AF1, DS04X)
#define GPIO59_LCD_LDD_5	MFP_CFG_DRV(GPIO59, AF1, DS04X)
#define GPIO60_LCD_LDD_6	MFP_CFG_DRV(GPIO60, AF1, DS04X)
#define GPIO61_LCD_LDD_7	MFP_CFG_DRV(GPIO61, AF1, DS04X)
#define GPIO62_LCD_LDD_8	MFP_CFG_DRV(GPIO62, AF1, DS04X)
#define GPIO63_LCD_LDD_9	MFP_CFG_DRV(GPIO63, AF1, DS04X)
#define GPIO64_LCD_LDD_10	MFP_CFG_DRV(GPIO64, AF1, DS04X)
#define GPIO65_LCD_LDD_11	MFP_CFG_DRV(GPIO65, AF1, DS04X)
#define GPIO66_LCD_LDD_12	MFP_CFG_DRV(GPIO66, AF1, DS04X)
#define GPIO67_LCD_LDD_13	MFP_CFG_DRV(GPIO67, AF1, DS04X)
#define GPIO68_LCD_LDD_14	MFP_CFG_DRV(GPIO68, AF1, DS04X)
#define GPIO69_LCD_LDD_15	MFP_CFG_DRV(GPIO69, AF1, DS04X)
#define GPIO70_LCD_LDD_16	MFP_CFG_DRV(GPIO70, AF1, DS04X)
#define GPIO71_LCD_LDD_17	MFP_CFG_DRV(GPIO71, AF1, DS04X)
#else
...
#define GPIO106_ULPI_RESET	MFP_CFG_LPM(GPIO106,  AF0, DRIVE_LOW)
