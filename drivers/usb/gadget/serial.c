...
#define GS_PRODUCT_ID			0xa4a8	/* Linux-USB Serial Gadget */
//#define GS_VENDOR_ID			0x8086	/* for USB Serial Driver */
//#define GS_PRODUCT_ID			0x07d6	/* for USB Serial Driver */
#define GS_CDC_PRODUCT_ID		0xa4a7	/* ... as CDC-ACM */
#define GS_CDC_OBEX_PRODUCT_ID		0xa4a9	/* ... as CDC-OBEX */

/* 0xa4a8 is for serial port */
/* 0xa4aa is for modem port */
static __u16 product = GS_CDC_PRODUCT_ID;
...
static int __init init(void)
{
	...
	if (use_acm) {
		...
		device_desc.idProduct =
				__constant_cpu_to_le16(product);
	} else if (use_obex) {
