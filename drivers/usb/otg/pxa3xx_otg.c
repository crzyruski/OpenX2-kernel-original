...
static void pxa_otg_set_vbus(int vbus_type)
{
    gpio_request(MFP_PIN_GPIO29, "CHG");
    gpio_request(MFP_PIN_GPIO18,"USB HOST");
    switch(vbus_type) {
        case VBUS_HIGH:
            printk("VBUS_HIGH\n");
            gpio_direction_output(MFP_PIN_GPIO29,GPIO_LEVEL_HIGH);
            mdelay(20);
            gpio_direction_output(MFP_PIN_GPIO18,GPIO_LEVEL_HIGH);
            mdelay(20);
            vbus_valid = 1;
            break;
        case VBUS_LOW:
            gpio_direction_output(MFP_PIN_GPIO18,GPIO_LEVEL_LOW);
            mdelay(20);
            gpio_direction_output(MFP_PIN_GPIO29,GPIO_LEVEL_LOW);
            mdelay(20);
            vbus_valid = 0;
            break;
        default:
    ...
    gpio_free(MFP_PIN_GPIO29);
    gpio_free(MFP_PIN_GPIO18);
...
static void pxa3xx_update_otg(struct pxa_otg *pxa_otg)
{
    ...
    pr_debug("otg state form %d to %d\n", state, pxa_otg->otg.state);
