...
static void unset_dvfm_constraint(void) {}
#endif
#define LITTLETON_MICCO_HIFI_RATES (SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_11025 |\
...
#if 1 /* wait marvel to fix 44.1k */
	cpu_dai->playback.rates = LITTLETON_MICCO_HIFI_RATES;
#else /* 48 3.072 12.288 44.1 2.822 11.2896 */
...
/* for audio-record suspend-current-leak */
#if 0 /* we need this? rm by frank */
